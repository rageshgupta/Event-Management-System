        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                ...
                //links non database contents. *if logged out
                    ...
                    echo '<li><a href = "events2.php"View>Upcoming Events</a></li>';
                    ...
                    echo '<button type = "button" class = "btn btn-primary" data-toggle = "modal" data-target = "#login">Admin Login</button>';
                }
                ?>
